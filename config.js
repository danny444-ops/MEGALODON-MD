...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~lJwHwQZb#UM61PSsa9oI_12FtEZ9k6BLdgGdr9sp8iu5fum8kOpY",  // Your bot's session ID (keep it secure)
    PREFIX: process.env.PREFIX || "$",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || "DANNITO-MD",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || "DANNITO",           // Owner's name
